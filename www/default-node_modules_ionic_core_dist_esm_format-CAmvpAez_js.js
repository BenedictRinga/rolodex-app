"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-node_modules_ionic_core_dist_esm_format-CAmvpAez_js"],{
...
/* harmony export */   A: () => (/* binding */ getNextWeek),
/* harmony export */   B: () => (/* binding */ parseMinParts),
/* harmony export */   C: () => (/* binding */ parseMaxParts),
/* harmony export */   D: () => (/* binding */ parseDate),
/* harmony export */   E: () => (/* binding */ warnIfValueOutOfBounds),
/* harmony export */   F: () => (/* binding */ parseAmPm),
/* harmony export */   G: () => (/* binding */ clampDate),
/* harmony export */   H: () => (/* binding */ convertToArrayOfNumbers),
/* harmony export */   I: () => (/* binding */ convertDataToISO),
/* harmony export */   J: () => (/* binding */ getClosestValidDate),
/* harmony export */   K: () => (/* binding */ isMonthFirstLocale),
/* harmony export */   L: () => (/* binding */ isLocaleDayPeriodRTL),
/* harmony export */   M: () => (/* binding */ calculateHourFromAMPM),
/* harmony export */   N: () => (/* binding */ getMonthAndYear),
/* harmony export */   O: () => (/* binding */ getLocalizedTime),
/* harmony export */   P: () => (/* binding */ getLocalizedDateTime),
/* harmony export */   Q: () => (/* binding */ formatValue),
/* harmony export */   a: () => (/* binding */ getPreviousMonth),
/* harmony export */   b: () => (/* binding */ getTodayLabel),
/* harmony export */   c: () => (/* binding */ getYear),
/* harmony export */   d: () => (/* binding */ getHourCycle),
/* harmony export */   e: () => (/* binding */ getInternalHourValue),
/* harmony export */   f: () => (/* binding */ getFormattedHour),
/* harmony export */   g: () => (/* binding */ getNextMonth),
/* harmony export */   h: () => (/* binding */ addTimePadding),
/* harmony export */   i: () => (/* binding */ isSameDay),
/* harmony export */   j: () => (/* binding */ getLocalizedDayPeriod),
/* harmony export */   k: () => (/* binding */ isBefore),
/* harmony export */   l: () => (/* binding */ isAfter),
/* harmony export */   m: () => (/* binding */ is24Hour),
/* harmony export */   n: () => (/* binding */ getNumDaysInMonth),
/* harmony export */   o: () => (/* binding */ getDay),
/* harmony export */   p: () => (/* binding */ generateDayAriaLabel),
/* harmony export */   q: () => (/* binding */ getPartsFromCalendarDay),
/* harmony export */   r: () => (/* binding */ removeDateTzOffset),
/* harmony export */   s: () => (/* binding */ getNextYear),
/* harmony export */   t: () => (/* binding */ getPreviousYear),
/* harmony export */   u: () => (/* binding */ getEndOfWeek),
/* harmony export */   v: () => (/* binding */ validateParts),
/* harmony export */   w: () => (/* binding */ getStartOfWeek),
/* harmony export */   x: () => (/* binding */ getPreviousDay),
/* harmony export */   y: () => (/* binding */ getNextDay),
/* harmony export */   z: () => (/* binding */ getPreviousWeek)
/* harmony export */ });
...
const warnIfValueOutOfBounds = (value, min, max) => {
  ...
  for (const val of valueArray) {
    if (min !== undefined && isBefore(val, min) || max !== undefined && isAfter(val, max)) {
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.f)('[ion-datetime] - The value provided to ion-datetime is out of bounds.\n\n' + `Min: ${JSON.stringify(min)}\n` + `Max: ${JSON.stringify(max)}\n` + `Value: ${JSON.stringify(value)}`);
      break;
    }
  }
};
...
function parseDate(val) {
  ...
  if (parse === null) {
    ...
    (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.f)(`[ion-datetime] - Unable to parse date string: ${val}. Please provide a valid ISO 8601 datetime string.`);
    return undefined;
  }
...
//# sourceMappingURL=default-node_modules_ionic_core_dist_esm_format-CAmvpAez_js.js.map