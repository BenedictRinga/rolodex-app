...
/* harmony import */ var _index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index-B_8X7INq.js */ 1839);
...
/* harmony import */ var _ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ionic-global-Cp_eT4sZ.js */ 8451);
/* harmony import */ var _animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./animation-DLJpuoEz.js */ 3642);
/* harmony import */ var _config_DQCONYYp_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./config-DQCONYYp.js */ 292);
...
/* harmony import */ var _dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./dir-o8OKV5aD.js */ 8789);
/* harmony import */ var _capacitor_CFERIeaU_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./capacitor-CFERIeaU.js */ 5051);
...
const createBaseAnimation = pullingRefresherIcon => {
  ...
  const baseAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_7__.c)().duration(1000).easing('ease-out');
  const spinnerArrowContainerAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(spinnerArrowContainer).keyframes([{
    offset: 0,
    opacity: '0.3'
  }, {
    offset: 0.45,
  ...
  const circleInnerAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(circle).keyframes([{
    offset: 0,
  ...
  const circleOuterAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(spinner).keyframes([{
    offset: 0,
  ...
  if (arrowContainer && arrow) {
    const arrowContainerAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(arrowContainer).keyframes([{
      offset: 0,
    ...
    const arrowAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(arrow).keyframes([{
      offset: 0,
...
const createScaleAnimation = (pullingRefresherIcon, refresherEl) => {
  ...
  const spinnerAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(pullingRefresherIcon).keyframes([{
    offset: 0,
...
const createSnapBackAnimation = pullingRefresherIcon => {
  return (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_7__.c)().duration(125).addElement(pullingRefresherIcon).fromTo('transform', 'translateY(var(--ion-pulling-refresher-translate, 100px))', 'translateY(0px)');
};
...
const handleScrollWhilePulling = (ticks, numTicks, pullAmount) => {
  ...
  (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => {
    ticks.forEach((el, i) => {
      ...
      const progression = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.e)(0, start / range, 1);
...
const translateElement = (el, value, duration = 200) => {
  ...
  const trans = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.t)(el, duration);
  (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => {
...
const shouldUseNativeRefresher = /*#__PURE__*/function () {
  var _ref = (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (referenceEl, mode) {
    const refresherContent = referenceEl.querySelector('ion-refresher-content');
    if (!refresherContent) {
      return Promise.resolve(false);
    }
    yield new Promise(resolve => (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.c)(refresherContent, resolve));
...
const Refresher = class {
  constructor(hostRef) {
    ...
    this.ionRefresh = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionRefresh", 7);
    this.ionPull = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionPull", 7);
    this.ionStart = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionStart", 7);
    this.ionPullStart = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionPullStart", 7);
    this.ionPullEnd = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionPullEnd", 7);
  ...
  checkNativeRefresher() {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const useNativeRefresher = yield shouldUseNativeRefresher(_this.el, (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_6__.b)(_this));
  ...
  resetNativeRefresher(el, state) {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.state = state;
      if ((0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_6__.b)(_this2) === 'ios') {
        yield translateElement(el, undefined, 300);
      } else {
        yield (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.t)(_this2.el.querySelector('.refresher-refreshing-icon'), 200);
      }
  ...
  setupiOSNativeRefresher(pullingSpinner, refreshingSpinner) {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => ticks.forEach(el => el.style.setProperty('animation', 'none')));
        ...
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.a)(() => {
          ...
          if (scrollTop > 0) {
            ...
            if (_this3.state === 8 /* RefresherState.Refreshing */) {
              const ratio = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.e)(0, scrollTop / (refresherHeight * 0.5), 1);
              (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => setSpinnerOpacity(refreshingSpinner, 1 - ratio));
              return;
            }
            return;
          }
          ...
          const pullAmount = _this3.progress = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.e)(0, (Math.abs(scrollTop) - offset) / MAX_PULL, 1);
      ...
      const {
        createGesture
      } = yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-Bck1OwMs.js */ 7584));
      /**
      ...
      _this3.gesture = createGesture({
        ...
        onEnd: () => {
          ...
          if (_this3.needsCompletion) {
            ...
            (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.a)(() => translateElement(_this3.elementToTransform, `${_this3.el.clientHeight}px`));
          } else if (hadStarted) {
            /**
  ...
  setupMDNativeRefresher(contentEl, pullingSpinner, refreshingSpinner) {
    var _this4 = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const circle = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.g)(pullingSpinner).querySelector('circle');
      const pullingRefresherIcon = _this4.el.querySelector('ion-refresher-content .refresher-pulling-icon');
      const refreshingCircle = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.g)(refreshingSpinner).querySelector('circle');
      ...
      _this4.gesture = createGesture({
        ...
        onMove: ev => {
          ...
          if (!ev.data.didStart) {
            ...
            const overflowProperty = scrollEl.matches(_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_3__.I) ? 'overflow' : '--overflow';
            (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => scrollEl.style.setProperty(overflowProperty, 'hidden'));
          ...
          _this4.progress = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.e)(0, ev.deltaY / 180 * 0.5, 1);
        ...
        onEnd: ev => {
          ...
          const overflowProperty = scrollEl.matches(_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_3__.I) ? 'overflow' : '--overflow';
          (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => scrollEl.style.removeProperty(overflowProperty));
          ...
          (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.w)(/*#__PURE__*/(0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  setupNativeRefresher(contentEl) {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if ((0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_6__.b)(_this5) === 'ios') {
  ...
  connectedCallback() {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this6.el.getAttribute('slot') !== 'fixed') {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-refresher] - Make sure you use: <ion-refresher slot="fixed">');
        return;
      }
      const contentEl = _this6.el.closest(_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_3__.c);
      if (!contentEl) {
        (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_3__.p)(_this6.el);
        return;
      }
      /**
       ...
       */
      (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.c)(contentEl, /*#__PURE__*/(0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        const customScrollTarget = (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_3__.e)(contentEl);
        /**
         ...
         */
        _this6.scrollEl = yield (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_3__.g)(customScrollTarget !== null && customScrollTarget !== void 0 ? customScrollTarget : contentEl);
        /**
        ...
        if (yield shouldUseNativeRefresher(_this6.el, (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_6__.b)(_this6))) {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this7.nativeRefresher) {
        ...
        if (!_this7.pointerDown) {
          (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => _this7.resetNativeRefresher(_this7.elementToTransform, 32 /* RefresherState.Completing */)));
        }
      } else {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this8.nativeRefresher) {
        ...
        if (!_this8.pointerDown) {
          (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => _this8.resetNativeRefresher(_this8.elementToTransform, 16 /* RefresherState.Cancelling */)));
        }
      } else {
  ...
  render() {
    const mode = (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_6__.b)(this);
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      key: '6b94f11bd5382bdf4e92c43d4b5d0550c290852d',
      slot: "fixed",
      class: {
        [mode]: true,
...
const RefresherContent = class {
  constructor(hostRef) {
    (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.customHTMLEnabled = _index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.get('innerHTMLTemplatesEnabled', _config_DQCONYYp_js__WEBPACK_IMPORTED_MODULE_8__.E);
  }
  componentWillLoad() {
    if (this.pullingIcon === undefined) {
      ...
      this.pullingIcon = _index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.get('refreshingIcon', mode === 'ios' && hasRubberBandScrolling ? _index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.get('spinner', overflowRefresher) : 'circular');
    }
    if (this.refreshingSpinner === undefined) {
      const mode = (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_6__.b)(this);
      this.refreshingSpinner = _index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.get('refreshingSpinner', _index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.get('spinner', mode === 'ios' ? 'lines' : 'circular'));
    }
  }
  renderPullingText() {
    const {
    ...
    if (customHTMLEnabled) {
      return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
        ...
        innerHTML: (0,_config_DQCONYYp_js__WEBPACK_IMPORTED_MODULE_8__.a)(pullingText)
      });
    }
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "refresher-pulling-text"
  ...
  renderRefreshingText() {
    ...
    if (customHTMLEnabled) {
      return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
        ...
        innerHTML: (0,_config_DQCONYYp_js__WEBPACK_IMPORTED_MODULE_8__.a)(refreshingText)
      });
    }
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "refresher-refreshing-text"
  ...
  render() {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, {
    ...
    }, this.pullingIcon && hasSpinner && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-spinner", {
      key: '0dde3578a80cc4b77a07c4d1db1af80c7eb10c27',
      name: this.pullingIcon,
      paused: true
    }), mode === 'md' && this.pullingIcon === 'circular' && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      lazy: false,
      "aria-hidden": "true"
    })), this.pullingText !== undefined && this.renderPullingText()), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '98e22ceb0f7883e871f815f6199f5cb313e2e086',
      class: "refresher-refreshing"
    }, this.refreshingSpinner && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
