...
/* harmony import */ var _framework_delegate_B9yvYzqV_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./framework-delegate-B9yvYzqV.js */ 2401);
...
const Tab = class {
  ...
  changeActive(isActive) {
    if (isActive) {
      this.prepareLazyLoaded().catch(e => {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-tab] - Exception in prepareLazyLoaded:', e);
      });
    }
  }
  prepareLazyLoaded() {
    ...
    if (this.loadPromise === undefined) {
      this.loadPromise = (0,_framework_delegate_B9yvYzqV_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.delegate, this.el, this.component, ['ion-page']).catch(e => {
  ...
  render() {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      key: 'c35c9f96ed3a73270b23f30d9e279dcad9032e28',
      role: "tabpanel",
      ...
      key: '1c03523327e571f9ba140be0ccd6fe089e16a77a'
    }));
  }
  get el() {
...
const Tabs = class {
  constructor(hostRef) {
    ...
    this.ionTabsWillChange = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionTabsWillChange", 3);
    this.ionTabsDidChange = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionTabsDidChange", 3);
...
const getTab = (tabs, tab) => {
  ...
  if (!tabEl) {
    (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.j)(`[ion-tabs] - Tab with id: "${tabEl}" does not exist`);
  }
  return tabEl;
};
Tabs.style = tabsCss();
