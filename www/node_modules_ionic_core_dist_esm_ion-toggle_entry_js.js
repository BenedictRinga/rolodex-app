...
/* harmony import */ var _item_multiple_inputs_DlNuqNJm_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./item-multiple-inputs-DlNuqNJm.js */ 9424);
...
const Toggle = class {
  constructor(hostRef) {
     ...
     */
    this.enableOnOffLabels = _index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.get('toggleOnOffLabels');
    /**
    ...
    this.onClick = ev => {
       ...
       * only trigger on iOS.
       */
      const enableHaptics = (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_6__.a)('ios');
      if (this.disabled) {
        return;
      }
      ev.preventDefault();
      if (this.lastDrag + 300 < Date.now()) {
        this.toggleChecked();
        enableHaptics && (0,_haptic_DzAMWJuk_js__WEBPACK_IMPORTED_MODULE_5__.c)();
      }
    };
    /**
    ...
    this.getSwitchLabelIcon = (mode, checked) => {
      if (mode === 'md') {
        return checked ? _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_9__.f : _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_9__.r;
      }
      return checked ? _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_9__.r : _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_9__.g;
    };
  }
  disabledChanged() {
    if (this.gesture) {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (typeof MutationObserver !== 'undefined') {
        _this2.validationObserver = new MutationObserver(() => {
          const newIsInvalid = (0,_validity_DJztqcrH_js__WEBPACK_IMPORTED_MODULE_4__.c)(el);
      ...
      _this2.isInvalid = (0,_validity_DJztqcrH_js__WEBPACK_IMPORTED_MODULE_4__.c)(el);
      _this2.itemFocusObserver = (0,_item_multiple_inputs_DlNuqNJm_js__WEBPACK_IMPORTED_MODULE_3__.c)(el, () => (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.i)(_this2), ['item-multiple-inputs', 'ion-activatable']);
    })();
  }
  componentDidLoad() {
    this.setupGesture();
  ...
  componentWillLoad() {
    this.inheritedAttributes = Object.assign({}, (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_2__.i)(this.el));
  ...
  onMove(detail) {
    if (shouldToggle((0,_dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_7__.i)(this.el), this.checked, detail.deltaX, -10)) {
      this.toggleChecked();
      (0,_haptic_DzAMWJuk_js__WEBPACK_IMPORTED_MODULE_5__.c)();
    }
  }
  onEnd(ev) {
    this.activated = false;
  ...
  renderToggleControl() {
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  render() {
    ...
    const inItem = (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_8__.h)('ion-item', el);
    const inMultipleInputsItem = (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_8__.h)('ion-item.item-multiple-inputs', el);
    ...
    const inClickableItem = (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_8__.h)('ion-item.ion-activatable, ion-item[button], ion-item[href]', el);
    (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_2__.a)(true, el, name, checked ? value : '', disabled);
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      key: 'e2fb9e7fb497511a8f763895fab34f20d5f8cb9e',
      role: "switch",
      ...
      key: 'ab95b2af493f6352abefbc8661b112796ed12035',
      ...
      key: '3bdabb3c25ec4417b0e968bae12f7365a77acb65',
      class: {
      ...
      key: '3de9890950b5066173d49a6d615e415d286e4aa5'
    }), this.renderHintText()), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'de233f83efd106d043b31cceb5eb9a6e5758d032',
