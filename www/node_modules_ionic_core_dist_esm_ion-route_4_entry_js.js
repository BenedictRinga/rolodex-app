...
/* harmony import */ var _helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers-DkCLSLI9.js */ 8169);
...
/* harmony import */ var _ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ionic-global-Cp_eT4sZ.js */ 8451);
/* harmony import */ var _dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dir-o8OKV5aD.js */ 8789);
...
const Route = class {
  constructor(hostRef) {
    ...
    this.ionRouteDataChanged = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionRouteDataChanged", 7);
    /**
...
const RouteRedirect = class {
  constructor(hostRef) {
    (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.ionRouteRedirectChanged = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionRouteRedirectChanged", 7);
  }
  propDidChange() {
...
const _writeNavState = /*#__PURE__*/function () {
  var _ref = (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (root, chain, direction, index, changed = false, animation) {
    try {
      ...
      yield new Promise(resolve => (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_2__.c)(outlet, resolve));
      ...
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-router] - Exception in writeNavState:', e);
      return false;
    }
  });
...
const readNavState = /*#__PURE__*/function () {
  var _ref2 = (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (root) {
    const ids = [];
    let outlet;
    let node = root;
...
const nextFrame = () => new Promise(resolve => (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => resolve()));
/**
 ...
 */
const findFragmentTarget = /*#__PURE__*/function () {
  var _ref3 = (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (fragment, shouldContinue) {
  ...
  return function findFragmentTarget(_x6, _x7) {
 ...
 */
const scrollToFragment = /*#__PURE__*/function () {
  var _ref4 = (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (fragment, shouldContinue = () => true) {
    ...
    try {
      const contentHost = (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_3__.a)(target);
      if (contentHost && (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_3__.i)(contentHost)) {
        const content = contentHost;
        const scrollEl = yield (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_3__.g)(content);
      ...
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-router] - Exception in scrollToFragment:', e);
      return false;
    }
  });
  return function scrollToFragment(_x8) {
...
const Router = class {
  constructor(hostRef) {
    (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.ionRouteWillChange = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionRouteWillChange", 7);
    this.ionRouteDidChange = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionRouteDidChange", 7);
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (canProceed !== true) {
        if (typeof canProceed === 'object') {
          ...
          _this.setSegments(path.segments, ROUTER_INTENT_NONE, path.queryString, path.fragment);
          const result = yield _this.writeNavStateRoot(path.segments, ROUTER_INTENT_NONE);
          if (result) {
            _this.maybeScrollToFragment();
          }
        }
        return;
      }
      const result = yield _this.onRoutesChanged();
      if (result) {
        _this.maybeScrollToFragment();
      }
    })();
  ...
  componentDidLoad() {
    window.addEventListener('ionRouteRedirectChanged', (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_2__.p)(this.onRedirectChanged.bind(this), 10));
    window.addEventListener('ionRouteDataChanged', (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_2__.p)(this.onRoutesChanged.bind(this), 100));
  }
  onPopState() {
    var _this2 = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const result = yield _this2.writeNavStateRoot(segments, direction);
      if (result) {
        _this2.maybeScrollToFragment();
      }
      return result;
    })();
  }
  ...
  push(_x9) {
    var _this4 = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (path, direction = 'forward', animation) {
      var _a;
      if (path.startsWith('.')) {
      ...
      _this4.setSegments(parsedPath.segments, direction, parsedPath.queryString, parsedPath.fragment);
      const result = yield _this4.writeNavStateRoot(parsedPath.segments, direction, animation);
      if (result) {
        _this4.maybeScrollToFragment();
      }
      return result;
  ...
  navChanged(direction) {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this6.busy) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-router] - Router is busy, navChanged was cancelled.');
        return false;
      }
      const {
        ids,
      ...
      if (!chain) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-router] - No matching URL for', ids.map(i => i.id));
        return false;
      }
      const segments = chainToSegments(chain);
      if (!segments) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-router] - Router could not match path because some required param is missing.');
        return false;
      }
      ...
      const fragment = newPath === _this6.previousPath ? _this6.getFragment() : undefined;
      _this6.setSegments(segments, direction, undefined, fragment);
  ...
  writeNavStateRoot(segments, direction, animation) {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!segments) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-router] - URL is not part of the routing set.');
        return false;
      }
      ...
      if (redirect) {
        ...
        _this7.setSegments(toSegments, direction, queryString, fragment);
      ...
      if (!chain) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-router] - The path does not match any route.');
        return false;
      }
      // write DOM give
  ...
  safeWriteNavState(_x0, _x1, _x10, _x11, _x12) {
    var _this8 = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, chain, direction, segments, redirectFrom, index = 0, animation) {
      ...
      try {
        ...
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-router] - Exception in safeWriteNavState:', e);
      }
      unlock();
      return changed;
    }).apply(this, arguments);
  ...
  runGuards() {
    var _this0 = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (to = _this0.getSegments(), from) {
      if (from === undefined) {
  ...
  writeNavState(_x13, _x14, _x15, _x16, _x17) {
    var _this1 = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, chain, direction, segments, redirectFrom, index = 0, animation) {
      if (_this1.busy) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-router] - Router is busy, transition was cancelled.');
        return false;
      }
      _this1.busy = true;
...
const RouterLink = class {
  constructor(hostRef) {
    ...
    this.onClick = ev => {
      (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_4__.o)(this.href, ev, this.routerDirection, this.routerAnimation);
    };
  }
  render() {
    const mode = (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_5__.b)(this);
    const attrs = {
      href: this.href,
      rel: this.rel,
      target: this.target
    ...
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("a", Object.assign({
      key: '315966e14a17760f3f64197e8315200039787897'
    }, attrs), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
