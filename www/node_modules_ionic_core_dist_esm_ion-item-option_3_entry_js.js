...
/* harmony import */ var _index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-B_8X7INq.js */ 1839);
...
const ItemOption = class {
  ...
  render() {
    ...
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(TagType, Object.assign({
...
const ItemOptions = class {
  constructor(hostRef) {
    (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.ionSwipe = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionSwipe", 7);
    /**
  ...
  render() {
    const mode = (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_3__.b)(this);
    const isEnd = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.o)(this.side);
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, {
...
const ItemSliding = class {
  constructor(hostRef) {
    (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.ionDrag = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionDrag", 7);
    this.item = null;
    this.openAmount = 0;
  ...
  connectedCallback() {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.contentEl = (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_5__.a)(el);
      /**
       ...
       */
      _this2.mutationObserver = (0,_watch_options_Dtdm8lKC_js__WEBPACK_IMPORTED_MODULE_6__.w)(el, 'ion-item-option', /*#__PURE__*/(0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        yield _this2.updateOptions();
      }));
      yield _this2.updateOptions();
      _this2.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-Bck1OwMs.js */ 7584))).createGesture({
        el,
  ...
  open(side) {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      side = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.o)(side) ? 'end' : 'start';
  ...
  updateOptions() {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (let i = 0; i < options.length; i++) {
        ...
        const side = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.o)((_a = option.side) !== null && _a !== void 0 ? _a : option.getAttribute('side')) ? 'end' : 'start';
        if (side === 'start') {
  ...
  onStart() {
    ...
    if (contentEl) {
      this.initialContentScrollY = (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_5__.d)(contentEl);
    }
  ...
  onMove(gesture) {
    ...
    switch (this.sides) {
      ...
      case 0 /* ItemSide.None */:
        return;
      default:
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-item-sliding] - invalid ItemSideFlags value', this.sides);
        break;
    }
    let optsWidth;
  ...
  onEnd(gesture) {
    ...
    if (contentEl) {
      (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_5__.r)(contentEl, initialContentScrollY);
    }
