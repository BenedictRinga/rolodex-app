...
/* harmony import */ var _button_active_CXXy0FIE_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./button-active-CXXy0FIE.js */ 666);
...
/* harmony import */ var _index_Bck1OwMs_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index-Bck1OwMs.js */ 7584);
...
/* harmony import */ var _dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./dir-o8OKV5aD.js */ 8789);
/* harmony import */ var _hardware_back_button_B93Gru0Y_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./hardware-back-button-B93Gru0Y.js */ 8819);
/* harmony import */ var _framework_delegate_B9yvYzqV_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./framework-delegate-B9yvYzqV.js */ 2401);
...
const iosEnterAnimation = baseEl => {
  ...
  const backdropAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_8__.c)();
...
const ActionSheet = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionActionSheetDidPresent", 7);
    this.willPresent = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionActionSheetWillPresent", 7);
    this.willDismiss = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionActionSheetWillDismiss", 7);
    this.didDismiss = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionActionSheetDidDismiss", 7);
    ...
    this.isOpen = false;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_5__.B);
    };
  ...
  present() {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
      unlock();
    })();
  }
  /**
  ...
  dismiss(data, role) {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this2, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
      if (dismissed) {
   ...
   */
  onDidDismiss() {
    return (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionActionSheetDidDismiss');
  }
  /**
   ...
   */
  onWillDismiss() {
    return (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionActionSheetWillDismiss');
  }
  buttonClick(button) {
    var _this3 = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  getRadioButtons() {
    return this.getButtons().filter(b => {
      ...
      return role === 'radio' && !(0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_5__.i)(role);
    });
  }
  /**
  ...
  componentDidLoad() {
    ...
    if (!this.gesture && (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_7__.b)(this) === 'ios' && wrapperEl && groupEl) {
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.a)(() => {
        const isScrollable = groupEl.scrollHeight > groupEl.clientHeight;
        if (!isScrollable) {
          this.gesture = (0,_button_active_CXXy0FIE_js__WEBPACK_IMPORTED_MODULE_2__.c)(wrapperEl, refEl => refEl.classList.contains('action-sheet-button'));
  ...
  renderActionSheetButtons(filteredButtons) {
    ...
    return filteredButtons.map((b, index) => {
      ...
      return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, htmlAttrs, {
      ...
      }), b.text), mode === 'md' && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null));
    });
  }
  render() {
    const {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
    ...
    }, header !== undefined && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    }, header, this.subHeader && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'a119d4a93668e829f7106f11cbbdd437310f3e80',
      class: "action-sheet-sub-title"
    }, this.subHeader)), this.renderActionSheetButtons(buttons)), cancelButton && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      class: "action-sheet-button-inner"
    }, cancelButton.icon && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      key: 'b7ba489e1ee50524a5b4af670eef787844a16286',
      icon: cancelButton.icon,
      "aria-hidden": "true",
      lazy: false,
      class: "action-sheet-icon"
    }), cancelButton.text), mode === 'md' && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
