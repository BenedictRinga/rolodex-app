...
const Picker = class {
  constructor(hostRef) {
    ...
    this.ionInputModeChange = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionInputModeChange", 7);
  ...
  componentWillLoad() {
    (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).addEventListener('focusin', this.onFocusIn);
    (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).addEventListener('focusout', this.onFocusOut);
  }
  /**
   * @internal
