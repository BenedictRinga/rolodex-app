"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_ionic_core_components_p-Dw7GNDKq_js"],{
...
/* harmony export */ });
/* harmony import */ var _p_CmR5uXej_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./p-CmR5uXej.js */ 74);
/* harmony import */ var _p_BDd9Zrb9_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./p-BDd9Zrb9.js */ 9797);
/*!
...
const i = (i, r) => {
  ...
  const s = "40px",
    c = "back" === r.direction,
    l = r.leavingEl,
    p = (0,_p_BDd9Zrb9_js__WEBPACK_IMPORTED_MODULE_0__.g)(r.enteringEl),
    b = p.querySelector("ion-toolbar"),
    u = (0,_p_CmR5uXej_js__WEBPACK_IMPORTED_MODULE_1__.c)();
  if (u.addElement(p).fill("both").beforeRemoveClass("ion-page-invisible"), c ? u.duration((null !== (a = r.duration) && void 0 !== a ? a : 0) || 200).easing("cubic-bezier(0.47,0,0.745,0.715)") : u.duration((null !== (n = r.duration) && void 0 !== n ? n : 0) || 280).easing("cubic-bezier(0.36,0.66,0.04,1)").fromTo("transform", `translateY(${s})`, "translateY(0px)").fromTo("opacity", .01, 1), b) {
    const t = (0,_p_CmR5uXej_js__WEBPACK_IMPORTED_MODULE_1__.c)();
    t.addElement(b), u.addAnimation(t);
  }
  if (l && c) {
    u.duration((null !== (e = r.duration) && void 0 !== e ? e : 0) || 200).easing("cubic-bezier(0.47,0,0.745,0.715)");
    const i = (0,_p_CmR5uXej_js__WEBPACK_IMPORTED_MODULE_1__.c)();
    i.addElement((0,_p_BDd9Zrb9_js__WEBPACK_IMPORTED_MODULE_0__.g)(l)).onFinish(o => {
...
//# sourceMappingURL=node_modules_ionic_core_components_p-Dw7GNDKq_js.js.map