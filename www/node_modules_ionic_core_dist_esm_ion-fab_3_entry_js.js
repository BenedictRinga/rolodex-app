...
/* harmony import */ var _ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ionic-global-Cp_eT4sZ.js */ 8451);
...
const Fab = class {
  ...
  render() {
    ...
    const mode = (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_2__.b)(this);
...
const FabButton = class {
  constructor(hostRef) {
    ...
    this.onClick = ev => {
      ...
      if (this.type !== 'button' && (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.k)(el)) {
        this.submitForm(ev);
      }
      if (fab) {
        fab.toggle();
    ...
    if (typeof form === 'string') {
      ...
      if (el) {
        if (el instanceof HTMLFormElement) {
          ...
          (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-fab-button] - Form with selector: "#${form}" could not be found. Verify that the id is attached to a <form> element.`, this.el);
          return null;
        }
      } else {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-fab-button] - Form with selector: "#${form}" could not be found. Verify that the id is correct and the form is rendered in the DOM.`, this.el);
        return null;
      }
    }
    if (form !== undefined) {
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-fab-button] - The provided "form" element is invalid. Verify that the form is a HTMLFormElement and rendered in the DOM.`, this.el);
      return null;
    }
  ...
  render() {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      key: '89e8f2564f12f8c1cd8509a40359202347948846',
      ...
      key: '9e2fd462316e1aec50f53fa1b7ad7f02fd399592'
    }, attrs, {
      class: "button-native",
      part: "native",
      disabled: disabled,
      ...
      onBlur: this.onBlur,
      onClick: ev => type === 'button' && (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_4__.o)(href, ev, this.routerDirection, this.routerAnimation)
    }, inheritedAttributes), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      key: 'c3bdb8614eb249297afc963810066658dc85efd6',
      "aria-hidden": "true",
      icon: this.closeIcon,
      part: "close-icon",
      class: "close-icon",
      ...
      key: 'a6a505b24d21cc716d2e3351ad4c380b95c768d7',
      class: "button-inner"
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      key: 'f44fc1e95533438ee3adc8cc5bdd9e1e85849fd6'
    })), mode === 'md' && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
      key: 'b7c7dc7fceb0bb5613239608225f040010b7b2bd'
    })));
  }
  get el() {
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.g)(this);
