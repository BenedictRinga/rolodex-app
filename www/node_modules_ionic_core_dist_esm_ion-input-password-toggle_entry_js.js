...
const InputPasswordToggle = class {
  ...
  onTypeChange(newValue) {
    if (newValue !== 'text' && newValue !== 'password') {
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.f)(`[ion-input-password-toggle] - Only inputs of type "text" or "password" are supported. Input of type "${newValue}" is not compatible.`, this.el);
      return;
    }
  }
  connectedCallback() {
    ...
    if (!inputElRef) {
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.f)('[ion-input-password-toggle] - No ancestor ion-input found. This component must be slotted inside of an ion-input.', el);
      return;
    }
    /**
