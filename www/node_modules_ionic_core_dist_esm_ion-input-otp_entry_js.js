...
const InputOTP = class {
  constructor(hostRef) {
    ...
    this.ionComplete = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionComplete", 7);
  ...
  processSeparators() {
    ...
    if (typeof separators === 'string' && separators !== 'all') {
      ...
      if (!isValidFormat) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-input-otp] - Invalid separators format. Expected a comma-separated list of numbers, an array of numbers, or "all". Received: ${separators}`, this.el);
        this.parsedSeparators = [];
        return;
      }
    }
    ...
    if (duplicates.length > 0) {
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-input-otp] - Duplicate separator positions are not allowed. Received: ${separators}`, this.el);
    }
    const invalidSeparators = separatorValues.filter(pos => pos > length);
    if (invalidSeparators.length > 0) {
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-input-otp] - The following separator positions are greater than the input length (${length}): ${invalidSeparators.join(', ')}. These separators will be ignored.`, this.el);
    }
    this.parsedSeparators = separatorValues.filter(pos => pos <= length);
  }
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_2__.i)(this.el);
  ...
  render() {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      key: 'ffeec6d07b5d3cd375b72d4c9f4fe755d80ac094',
      ...
      key: 'f42471e4ed8054f07162a52b42a0ca49c3d57bb0',
      role: "group",
      "aria-label": "One-time password input",
      class: "input-otp-group"
    }, inheritedAttributes), Array.from({
      length
    }).map((_, index) => (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.F, null, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "native-wrapper"
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
      class: "native-input",
      id: `${inputId}-${index}`,
    ...
    })), this.showSeparator(index) && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "input-otp-separator"
    })))), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'b06461605b2404476b856785b7116e18b4dbaeaa',
      class: {
        'input-otp-description': true,
        'input-otp-description-hidden': !hasDescription
      }
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      key: '5bf9e7dc365f6caf0d4b13ae26e5559cdbbd162c'
    })));
  }
  get el() {
