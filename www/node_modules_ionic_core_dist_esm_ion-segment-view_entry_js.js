...
/* harmony import */ var _dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dir-o8OKV5aD.js */ 8789);
...
const SegmentView = class {
  constructor(hostRef) {
    ...
    this.ionSegmentViewScroll = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionSegmentViewScroll", 7);
  ...
  handleScroll(ev) {
    ...
    const scrollRatio = ((0,_dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_2__.i)(this.el) ? -1 : 1) * (scrollLeft / max);
  ...
  setContent(_x) {
    var _this = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (id, smoothScroll = true) {
      ...
      _this.el.scrollTo({
        top: 0,
        left: ((0,_dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_2__.i)(_this.el) ? -1 : 1) * offset,
