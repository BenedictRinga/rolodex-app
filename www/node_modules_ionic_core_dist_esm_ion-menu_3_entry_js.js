...
/* harmony import */ var _overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlays-COCl_nm9.js */ 5046);
...
/* harmony import */ var _hardware_back_button_B93Gru0Y_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./hardware-back-button-B93Gru0Y.js */ 8819);
/* harmony import */ var _helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helpers-DkCLSLI9.js */ 8169);
/* harmony import */ var _index_DdeElWma_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-DdeElWma.js */ 1580);
...
/* harmony import */ var _framework_delegate_B9yvYzqV_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./framework-delegate-B9yvYzqV.js */ 2401);
/* harmony import */ var _dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./dir-o8OKV5aD.js */ 8789);
/* harmony import */ var _animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./animation-DLJpuoEz.js */ 3642);
...
const Menu = class {
  constructor(hostRef) {
    ...
    this.ionWillOpen = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionWillOpen", 7);
    this.ionWillClose = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionWillClose", 7);
    this.ionDidOpen = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionDidOpen", 7);
    this.ionDidClose = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionDidClose", 7);
    this.ionMenuChange = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionMenuChange", 7);
    this.lastOnEnd = 0;
    ...
    this.handleFocus = ev => {
       ...
       */
      const lastOverlay = (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_3__.o)(document);
  ...
  sideChanged() {
    this.isEndSide = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_6__.o)(this.side, this.el);
    /**
  ...
  connectedCallback() {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (_this.type === undefined) {
        _this.type = _index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.get('menuType', 'overlay');
      }
      const content = _this.contentId !== undefined ? document.getElementById(_this.contentId) : null;
      if (content === null) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-menu] - Must have a "content" element to listen for drag events on.');
        return;
      }
      if (_this.el.contains(content)) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.j)(`[ion-menu] - The "contentId" should refer to the main view's ion-content, not the ion-content inside of the ion-menu.`);
      }
      ...
      _index_DdeElWma_js__WEBPACK_IMPORTED_MODULE_7__.m._register(_this);
      _this.menuChanged();
      _this.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-Bck1OwMs.js */ 7584))).createGesture({
        el: document,
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el);
  }
  componentDidLoad() {
    var _this2 = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  disconnectedCallback() {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _index_DdeElWma_js__WEBPACK_IMPORTED_MODULE_7__.m._unregister(_this3);
      if (_this3.animation) {
  ...
  onBackdropClick(ev) {
    ...
    if (this._isOpen && this.lastOnEnd < ev.timeStamp - 100) {
      ...
      if (shouldClose) {
        ev.preventDefault();
        ev.stopPropagation();
        this.close(undefined, _overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_3__.B);
      }
    }
  }
  onKeydown(ev) {
  ...
  setOpen(shouldOpen, animated = true, role) {
    ...
    return _index_DdeElWma_js__WEBPACK_IMPORTED_MODULE_7__.m._setOpen(this, shouldOpen, animated, role);
  }
  trapKeyboardFocus(ev, doc) {
    ...
    if (this.el.contains(target)) {
       ...
       * here to avoid that.
       */
      (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_3__.n)(el);
      /**
      ...
      if (this.lastFocus === doc.activeElement) {
        (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_3__.q)(el);
      }
    }
  }
  _setOpen(_x) {
    var _this4 = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (shouldOpen, animated = true, role) {
  ...
  loadAnimation() {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
       ...
       * If the document direction changes, we need to create a new animation.
       */
      const isEndSide$1 = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_6__.o)(_this5.side, _this5.el);
      ...
      const animation = _this5.animation = yield _index_DdeElWma_js__WEBPACK_IMPORTED_MODULE_7__.m._createAnimation(_this5.type, _this5);
      if (!_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('animated', true)) {
  ...
  startAnimation(shouldOpen, animated) {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const mode = (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_8__.b)(_this6);
  ...
  canStart(detail) {
    ...
    if (this._isOpen) {
      return true;
    } else if (_index_DdeElWma_js__WEBPACK_IMPORTED_MODULE_7__.m._getOpenSync()) {
      return false;
    }
    return checkEdgeSide(window, detail.currentX, this.isEndSide, this.maxEdgeStart);
  }
  onWillStart() {
    this.beforeAnimation(!this._isOpen, _overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_3__.G);
    return this.loadAnimation();
  }
  onStart() {
    if (!this.isAnimating || !this.animation) {
      (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_6__.l)(false, 'isAnimating has to be true');
      return;
    }
  ...
  onEnd(detail) {
     ...
     */
    newStepValue += (0,_cubic_bezier_hHmYLOfE_js__WEBPACK_IMPORTED_MODULE_2__.g)([0, 0], [0.4, 0], [0.6, 1], [1, 1], (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_6__.e)(0, adjustedStepValue, 0.9999))[0] || 0;
    const playTo = this._isOpen ? !shouldComplete : shouldComplete;
    this.animation.easing('cubic-bezier(0.4, 0.0, 0.6, 1)').onFinish(() => this.afterAnimation(shouldOpen, _overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_3__.G), {
      oneTimeCallback: true
    }).progressEnd(playTo ? 1 : 0, this._isOpen ? 1 - newStepValue : newStepValue, 300);
  }
  beforeAnimation(shouldOpen, role) {
    (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_6__.l)(!this.isAnimating, '_before() should not be called while animating');
    /**
     ...
     */
    if ((0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_8__.a)('android')) {
  ...
  updateState() {
    ...
    if (!isActive) {
       ...
       */
      this.afterAnimation(false, _overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_3__.G);
    }
  }
  render() {
    const {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      key: 'e97587ece74feec95a3526bf4823538feb3b9ffc',
      onKeyDown: (0,_hardware_back_button_B93Gru0Y_js__WEBPACK_IMPORTED_MODULE_5__.shouldUseCloseWatcher)() ? null : this.onKeydown,
      role: "navigation",
      ...
      key: '0a8694d1772558f18b38332b3936d0f21fd35ce7',
      class: "menu-inner",
      part: "container",
      ref: el => this.menuInnerEl = el
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      key: '51fe03c098ed8a7f8ecdb12a1649424b4adfa59a'
    })), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-backdrop", {
      key: 'cd53a4d9ffef157bd95c652be76c92961f0ff480',
...
const updateVisibility = /*#__PURE__*/function () {
  var _ref = (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (menu) {
    const menuEl = yield _index_DdeElWma_js__WEBPACK_IMPORTED_MODULE_7__.m.get(menu);
...
const MenuButton = class {
  constructor(hostRef) {
     ...
     */
    this.type = 'button';
    this.onClick = /*#__PURE__*/(0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _index_DdeElWma_js__WEBPACK_IMPORTED_MODULE_7__.m.toggle(_this7.menu);
    });
  }
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el);
  ...
  render() {
    ...
    const mode = (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_8__.b)(this);
    const menuIcon = _index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.e.get('menuIcon', mode === 'ios' ? _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_10__.u : _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_10__.v);
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, {
    ...
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({
      ...
      lazy: false,
      "aria-hidden": "true"
    }))), mode === 'md' && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
...
const MenuToggle = class {
  constructor(hostRef) {
    ...
    this.autoHide = true;
    this.onClick = () => {
      return _index_DdeElWma_js__WEBPACK_IMPORTED_MODULE_7__.m.toggle(this.menu);
    };
  }
  connectedCallback() {
    this.visibilityChanged();
