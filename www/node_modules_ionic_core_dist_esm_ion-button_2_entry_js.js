...
const Button = class {
  constructor(hostRef) {
    (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
    this.ionFocus = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "ionFocus", 7);
    this.ionBlur = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "ionBlur", 7);
    this.inItem = false;
    ...
    this.handleClick = ev => {
      ...
      } else if ((0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_1__.k)(el)) {
        this.submitForm(ev);
      }
    };
    this.onFocus = () => {
  ...
  onAriaChanged(newValue, _oldValue, propName) {
    ...
    (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.i)(this);
  }
  /**
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_1__.i)(this.el);
  }
  get hasIconOnly() {
    ...
    if (typeof form === 'string') {
      ...
      if (el) {
        if (el instanceof HTMLFormElement) {
           ...
           */
          (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.f)(`[ion-button] - Form with selector: "#${form}" could not be found. Verify that the id is attached to a <form> element.`, this.el);
          return null;
        }
      } else {
        /**
         ...
         */
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.f)(`[ion-button] - Form with selector: "#${form}" could not be found. Verify that the id is correct and the form is rendered in the DOM.`, this.el);
        return null;
      }
    }
    if (form !== undefined) {
       ...
       */
      (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.f)(`[ion-button] - The provided "form" element is invalid. Verify that the form is a HTMLFormElement and rendered in the DOM.`, this.el);
      return null;
    }
    /**
  ...
  render() {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.d, {
      key: '82c71b8cbf3bb51e443f4aa99c375bf5be6b8dc7',
    ...
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.h)(TagType, Object.assign({
      ...
      onBlur: this.onBlur
    }, inheritedAttributes), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", {
      key: '40e127fc11c889e77b8bf02e8714f0dea83bfce7',
      class: "button-inner"
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", {
      key: 'e11c8c86d3f0894658a8999129425c9c111f5540',
      name: "icon-only",
      onSlotchange: this.slotChanged
    }), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", {
      key: '105ea9259ea17036359e6fe7eced8b267ab8e0f6',
      name: "start"
    }), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", {
      key: '0d7b0966e328a5b10b0562dacbd638dfd08d92af'
    }), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", {
      key: 'c542b40685802464d69f57ecc0a7c3465d24a417',
      name: "end"
    })), mode === 'md' && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", {
      key: '46df4cbeb057b0a8daab92226121d8bbb8c0ee07',
      type: this.rippleType
    })));
  }
  get el() {
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.g)(this);
  }
  static get watchers() {
    return {
      "disabled": [{
...
const getNamedUrl = (iconName, iconEl) => {
  ...
  try {
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.k)(`svg/${iconName}.svg`);
  } catch (e) {
    console.log('e', e);
    /**
...
const Icon = class {
  ...
  render() {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.d, Object.assign({
    ...
    }, inheritedAttributes), this.svgContent ? (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
      class: "icon-inner",
      innerHTML: this.svgContent
    }) : (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
      class: "icon-inner"
    }));
  }
