...
/* harmony import */ var _dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dir-o8OKV5aD.js */ 8789);
...
function getDecimalPlaces(n) {
  if (!(0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.j)(n)) return 0;
  if (n % 1 === 0) return 0;
...
const Range = class {
  constructor(hostRef) {
    ...
    this.ionInput = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionInput", 7);
    ...
    this.ionKnobMoveStart = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionKnobMoveStart", 7);
    this.ionKnobMoveEnd = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionKnobMoveEnd", 7);
    ...
    this.clampBounds = value => {
      return (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.e)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, this.ratioB + step, 1);
      }
  ...
  debounceChanged() {
     ...
     */
    this.ionInput = debounce === undefined ? originalIonInput !== null && originalIonInput !== void 0 ? originalIonInput : ionInput : (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.d)(ionInput, debounce);
  }
  dualKnobsChanged() {
    if (!this.noUpdate) {
      this.updateRatio();
  ...
  minChanged(newValue) {
    if (!(0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.j)(newValue)) {
      this.min = 0;
    }
    if (!this.noUpdate) {
      this.updateRatio();
  ...
  activeBarStartChanged() {
    ...
    if (activeBarStart !== undefined) {
      if (activeBarStart > this.max) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-range] - The value of activeBarStart (${activeBarStart}) is greater than the max (${this.max}). Valid values are greater than or equal to the min value and less than or equal to the max value.`, this.el);
        this.activeBarStart = this.max;
      } else if (activeBarStart < this.min) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-range] - The value of activeBarStart (${activeBarStart}) is less than the min (${this.min}). Valid values are greater than or equal to the min value and less than or equal to the max value.`, this.el);
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.el);
    // If min, max, or step are not safe, set them to 0, 100, and 1, respectively.
    // Each watch does this, but not before the initial load.
    this.min = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.j)(this.min) ? this.min : 0;
    this.max = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.j)(this.max) ? this.max : 100;
    this.step = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.j)(this.step) ? this.step : 1;
  }
  componentDidLoad() {
  ...
  connectedCallback() {
    ...
    const ionContent = (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.el);
  ...
  onMove(detail) {
    ...
    if (contentEl && this.pressedKnob === undefined) {
      this.initialContentScrollY = (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
    /**
  ...
  onEnd(detail) {
     ...
     */
    if (contentEl && this.pressedKnob !== undefined) {
      (0,_index_B_8X7INq_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialContentScrollY);
    }
  ...
  update(currentX) {
    ...
    let ratio = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, (currentX - rect.left) / rect.width, 1);
    if ((0,_dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el)) {
      ratio = 1 - ratio;
    }
    if (this.snaps) {
  ...
  renderRangeSlider() {
    ...
    const rtl = (0,_dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el);
    ...
    }, ticks.map(tick => (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  render() {
    ...
    (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.a)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      key: '81119ccd58016522bdac455a4e832d28b8d22d13',
      ...
      key: 'fac472b1d252560e83ca85bcc3eec6fec90d2cdf',
      class: "range-wrapper",
      id: "range-label"
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '2d920cde50fdac003caa902c945e2ac71160e701',
      class: {
        'label-text-wrapper': true,
        'label-text-wrapper-hidden': !hasLabel
      },
      part: "label"
    }, label !== undefined ? (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "label-text"
    }, label) : (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "label"
    })), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'f81e7c7c9f6620b7c5f848689adb67402aa508d1',
      class: "native-wrapper"
    }, (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      key: '29bcf499b855fa4f3d3069b8a9efbdc1a5b32f0e',
      name: "start"
    }), this.renderRangeSlider(), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      key: '5c1b25c5ca6a8a05e102648db85b9c8d1c86de25',
      name: "end"
    }))));
  }
  get el() {
...
const renderKnob = (rtl, {
  ...
  return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    "aria-valuenow": value
  }, pin && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-pin",
    role: "presentation",
  ...
  }, pinFormatter(value)), (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-knob",
    role: "presentation",
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  const clampedValue = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.e)(min, value, max);
  return roundToMaxDecimalPlaces(clampedValue, min, max, step);
};
const valueToRatio = (value, min, max) => {
  return (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, (value - min) / (max - min), 1);
};
let rangeIds = 0;
Range.style = {
  ios: rangeIosCss(),
