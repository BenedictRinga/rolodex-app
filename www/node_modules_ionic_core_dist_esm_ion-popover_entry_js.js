...
/* harmony import */ var _overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./overlays-COCl_nm9.js */ 5046);
...
/* harmony import */ var _index_Dsz7OTeL_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-Dsz7OTeL.js */ 337);
/* harmony import */ var _animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./animation-DLJpuoEz.js */ 3642);
/* harmony import */ var _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index-ZjP4CjeZ.js */ 575);
/* harmony import */ var _hardware_back_button_B93Gru0Y_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./hardware-back-button-B93Gru0Y.js */ 8819);
...
/* harmony import */ var _dir_o8OKV5aD_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./dir-o8OKV5aD.js */ 8789);
...
const configureDismissInteraction = (triggerEl, triggerAction, popoverEl, parentPopoverEl) => {
  ...
  const root = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.g)(parentPopoverEl);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const focusItem = item => {
  const root = (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.g)(item);
  const button = root.querySelector('button');
  if (button) {
    (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => button.focus());
  }
};
/**
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const backdropAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const contentAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_9__.c)();
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const backdropAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const wrapperAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const contentAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const viewportAnimation = (0,_animation_DLJpuoEz_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  backdropAnimation.addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionPopoverDidPresent", 7);
    this.willPresent = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionPopoverWillPresent", 7);
    this.willDismiss = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionPopoverWillDismiss", 7);
    this.didDismiss = (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionPopoverDidDismiss", 7);
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_2__.B);
    };
    ...
    this.configureTriggerInteraction = () => {
      ...
      if (!triggerEl) {
        (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-popover] - A trigger element with the ID "${trigger}" was not found in the DOM. The trigger element must be in the DOM when the "trigger" property is set on ion-popover.`, this.el);
        return;
      }
  ...
  connectedCallback() {
    ...
    (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_2__.j)(el);
    configureTriggerInteraction();
  }
  ...
  componentWillLoad() {
    ...
    const popoverId = (_b = (_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_2__.k)(el);
    this.parentPopover = el.closest(`ion-popover:not(#${popoverId})`);
    if (this.alignment === undefined) {
      this.alignment = (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_6__.b)(this) === 'ios' ? 'center' : 'start';
    }
  }
  componentDidLoad() {
    const {
    ...
    if (parentPopover) {
      (0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.f)(parentPopover, 'ionPopoverWillDismiss', () => {
  ...
  presentFromTrigger(_x3) {
    var _this = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, focusDescendant = false) {
  ...
  present(event) {
    ...
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_B9yvYzqV_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, el, _this2.component, ['popover-viewport'], _this2.componentProps, inline);
      ...
      if ((0,_helpers_DkCLSLI9_js__WEBPACK_IMPORTED_MODULE_4__.h)(el)) {
        yield (0,_index_Dsz7OTeL_js__WEBPACK_IMPORTED_MODULE_8__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_Dsz7OTeL_js__WEBPACK_IMPORTED_MODULE_8__.w)();
      }
      yield (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_2__.f)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_2__.n)(el);
      }
      unlock();
    })();
  }
  ...
  recalculateContentOnHeaderReady() {
    ...
    this.headerResizeObserver = new ResizeObserver(/*#__PURE__*/(0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _a;
  ...
  dismiss(_x4, _x5) {
    var _this4 = this;
    return (0,D_MacBook_noGoogle_rolodex_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data, role, dismissParentPopover = true) {
      ...
      const shouldDismiss = yield (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_2__.g)(_this4, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this4.event);
      if (shouldDismiss) {
        if (destroyKeyboardInteraction) {
          destroyKeyboardInteraction();
        ...
        yield (0,_framework_delegate_B9yvYzqV_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this4.usersElement);
      }
      unlock();
   ...
   */
  onDidDismiss() {
    return (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    ...
    const desktop = (0,_ionic_global_Cp_eT4sZ_js__WEBPACK_IMPORTED_MODULE_6__.a)('desktop');
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      ...
      class: Object.assign(Object.assign({}, (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.cssClass)), {
        ...
        [_overlays_COCl_nm9_js__WEBPACK_IMPORTED_MODULE_2__.F]: focusTrap === false,
    ...
    }), !parentPopover && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-backdrop", {
    ...
    }, enableArrow && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
